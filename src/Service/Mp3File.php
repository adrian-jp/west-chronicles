...
class Mp3File
{
    ...
    {
        $fd = fopen($_SERVER['DOCUMENT_ROOT'].'/west-chronicles/public/album/one/tracks/'.$this->filename, "r+");
    ...
    {
        $kbps = ($bitrate*1000)/8;
        $datasize = filesize($_SERVER['DOCUMENT_ROOT'].'/west-chronicles/public/album/one/tracks/'.$this->filename) - $offset;
